...
default['authconfig']['ipav2']['enable'] = false
default['authconfig']['ipav2']['domain'] = ''
default['authconfig']['ipav2']['realm'] = ''
default['authconfig']['ipav2']['server'] = ''
default['authconfig']['ipav2']['enablenontp'] = false
default['authconfig']['ipav2']['ipav2join'] = ''
...
default['authconfig']['cachecreds'] = true
